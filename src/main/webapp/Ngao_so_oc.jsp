      ...
      <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
        <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
          ...
          <div class ="icon_menu" style="display: flex">
            ...
            <a href="Cua.jsp" class="nav-item nav-link">Cua</a>
          </div>
      ...
      <div class="row">
        <div class="col-12 " aria-label="breadcrumb">
          <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="breadcrumb-item active"><span itemprop="name">Ngao - Sò - Ốc</span><meta itemprop="position" content="3"></li>
          </ol>
        </div>			</div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="product__grid item__grid row">
      <div class="col-xl-20th col-lg-20th col-md-4 col-sm-6 col-6 product-loop-new">
        ...
        <div class="product__item " data-id="1016070388">
          <div class="product__item--image">
            <a class="productUrl" data-coll-handle="" href="/products/bao-ngu-han-quoc-kg"><img class="width-100" width="480" height="480" srcset="//product.hstatic.net/1000030244/product/bn_31c802667db84419a4411ea7aab79302_large.jpg 480w, //product.hstatic.net/1000030244/product/bn_31c802667db84419a4411ea7aab79302_grande.jpg" alt="bao ngu han quoc song">
            </a>
            <div class="product__item--variant--size">Có 4 lựa chọn</div><div class="tag_icon ratiobox"><img class="heightwidth-auto" width="40" height="40" src="//theme.hstatic.net/1000030244/1001119993/14/icon_tag_3.png?v=1711" alt="sống "></div>	</div>
          <div class="product__item--info">
            <h3 class="product__item--title has-sale"><a class="productUrl " data-coll-handle="" href="/products/bao-ngu-han-quoc-kg">Bào Ngư Hàn Quốc Sống</a>
              <span class="product__item--sale">-17%</span></h3>

            <div class="product__item--price">
              <span class="product__item--price--normal">95,000đ<span class="product__item--variant">/ 1 Con</span></span>
              <del>115,000đ</del>
              <div class="product__item--action">
                <button type="button" class="btn product__item--quickview" data-proid="1016070388" data-price="95000đ" data-id="1083031413" data-handle="/products/bao-ngu-han-quoc-kg" data-max="">
      ...
      <div class="col-xl-20th col-lg-20th col-md-4 col-sm-6 col-6 product-loop-new">
        ...
        <div class="product__item " data-id="1000584893">
          <div class="product__item--image">
            <a class="productUrl" data-coll-handle="" href="/products/oc-huong"><img class="width-100" width="480" height="480" srcset="//product.hstatic.net/1000030244/product/100_4a38fbd3fc5349d590fab6dee7192fe6_large.jpg 480w, //product.hstatic.net/1000030244/product/100_4a38fbd3fc5349d590fab6dee7192fe6_grande.jpg" alt="oc huong song size 100 110 con">
            </a>
            <div class="product__item--variant--size">Có 2 lựa chọn</div><div class="tag_icon ratiobox"><img class="heightwidth-auto" width="40" height="40" src="//theme.hstatic.net/1000030244/1001119993/14/icon_tag_3.png?v=1711" alt="sống "></div>	</div>
          <div class="product__item--info">
            <h3 class="product__item--title has-sale"><a class="productUrl " data-coll-handle="" href="/products/oc-huong">Ốc Hương Sống (Size 100-110 con)</a>
              <span class="product__item--sale">-18%</span></h3>

            <div class="product__item--price">
              <span class="product__item--price--normal">225,000đ<span class="product__item--variant">/ 500g</span></span>
              <del>275,000đ</del>
              <div class="product__item--action">
                <button type="button" class="btn product__item--quickview" data-proid="1000584893" data-price="225000đ" data-id="1009141688" data-handle="/products/oc-huong" data-max="">
                  <svg id="" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.31 20.13">
                    <defs>
                      <style>
                        .cls-1 {
      ...
      <div class="col-12 paginate"><div id="pagination">
        <span class="page_node  current">1</span>
        <a class="page_node" href="/collections/ngao-so-oc?page=2" aria-label="Trang 2">2</a>
        <a class="next page_node" href="/collections/ngao-so-oc?page=2" aria-label="Trang sau"><i class="fa fa-angle-right"></i></a>
      </div></div>		</div>
