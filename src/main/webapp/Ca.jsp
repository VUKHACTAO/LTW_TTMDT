            ...
            <div class="row">
                <div class="col-12 " aria-label="breadcrumb">
                    <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="breadcrumb-item active"><span itemprop="name">CÁ</span><meta itemprop="position" content="3"></li>
                    </ol>
                </div>			</div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="product__grid item__grid row">
            <div class="col-xl-20th col-lg-20th col-md-4 col-sm-6 col-6 product-loop-new">
                ...
                <div class="product__item " data-id="1049515411">
                    <div class="product__item--image">
                        <a class="productUrl" data-coll-handle="" href="/products/ca-minh-thai"><img class="width-100" width="480" height="480" srcset="//product.hstatic.net/1000030244/product/artboard_1_c616840fdfa744b497ddc7d5afe51ab5_large.jpg 480w, //product.hstatic.net/1000030244/product/artboard_1_c616840fdfa744b497ddc7d5afe51ab5_grande.jpg" alt="ca minh thai alaska">
                        </a>
                        <div class="tag_icon new ratiobox"><img class="heightwidth-auto" width="40" height="40" src="//theme.hstatic.net/1000030244/1001119993/14/New.png?v=1714" alt="new"></div>	</div>
                    <div class="product__item--info">
                        <h3 class="product__item--title "><a class="productUrl " data-coll-handle="" href="/products/ca-minh-thai">Cá Minh Thái Alaska</a>
                        </h3>

                        <div class="product__item--price">
                            <span class="product__item--price--normal">115,000đ<span class="product__item--variant">/ Túi 250g</span></span>
                            <del></del>
                            <div class="product__item--action">
                                <button type="button" class="btn product__item--addcart" data-proid="1049515411" data-price="115000đ" data-id="1111006190" data-handle="/products/ca-minh-thai" data-max="">
            ...
            <div class="col-12 paginate"><div id="pagination">
                ...
                <a class="page_node" href="/collections/ca?page=2" aria-label="Trang 2">2</a>
                <a class="next page_node" href="/collections/ca?page=2" aria-label="Trang sau"><i class="fa fa-angle-right"></i></a>
            </div></div>		</div>
