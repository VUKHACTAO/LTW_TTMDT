                ...
                <div class="product__item " data-id="1023173089">
                    ...
                    <div class="product__item--info">
                        ...
                        <div class="product__item--price">
                            <span class="product__item--price--normal"><%=Format.fomatCurrency(products.getPrice())%><span class="product__item--variant">/ 1 Con</span></span>
                            <del>675,000đ</del>
                            <div class="product__item--action">

                                <button type="button" class="product__item--soldout">
                        ...
                        <div class="gift-content"> Mua Combo 3 Con Chỉ Còn 528K/Con</div>
                    </div>
                </div>
            </div>
            <%}%>
